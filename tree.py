...
class Tree:
    ...
    def _find(self, data, node):
        """Method for find data in the tree starting from node

        Args:
            data (int): data to find
            node (Node): root node from where to start the search
    ...
    def _printInorderTree(self, node):
        ...
        Args:
            node (Node): root node from where to start the printing
        """
        if node is not None:
